        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ><i class="fa fa-times text-danger text" onclick="return confirm('Are you sure?')"></i></a>
            </td>
          </tr>
          <?php
          }
