        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="{{URL::to('/delete-brand-product/'.$cate_pro->brand_id)}}" class="active styling-edit" ><i class="fa fa-times text-danger text" onclick="return confirm('Are you sure?')"></i></a>
            </td>
          </tr>
          <?php
          }
